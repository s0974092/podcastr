...
const CreatePodcast = () => {
  ...
  return (
    <section className='mt-10 flex flex-col'>
      <h1 className='text-20 font-blod text-white-1'>Create Podcast</h1>
      <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-col gap-2.5'>
                  ...
                  <FormControl>
                    <Input className='input-class focus-visible:ring-offset-orange-1' placeholder="Somebody Pro Podcast" {...field} />
                  </FormControl>
